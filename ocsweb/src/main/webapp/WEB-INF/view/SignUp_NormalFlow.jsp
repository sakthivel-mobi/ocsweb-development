                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div id="input-mobile-number" class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1">60</span><input
                                        id="login-mobile-number" class="form-control" value="" placeholder="Eg. 1xxxxxx"
                                        type="tel" aria-describedby="basic-addon1" />
                                </div>
                                ...
                                <div class="helper-text" style="font-size: x-small;">
                                    <p>
                                        Points to be Considered in providing Mobile Number:<br>
                                        Enter mobile number without country code and without any space
                                        or dash.<br> eg:"if you number is +60123456789 please enter
                                        123456789"
                                    </p>
                                    <p>
                            ...
                            <div class="mt-2" id="input-password" style="display: none;">
                                <label for="login-password">Password</label> <input id="login-password"
                                    class="form-control" value="" placeholder="Enter your Password *" maxlength="16"
                                    type="password" />
                                <div class="error-message" style="display: none;">Please
                            ...
                            <a class="btn btn-primary mt-2 w-100"
                                href="${pageContext.request.contextPath}/showMyLoginPage">I
