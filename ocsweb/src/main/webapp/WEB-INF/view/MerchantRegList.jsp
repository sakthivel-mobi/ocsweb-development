...
<script src="${pageContext.request.contextPath}/resources/js/moment.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/resources/js/xlsx.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/resources/js/loading.js"
	type="text/javascript"></script>
<!-- CDN moved to local -->
<link rel="stylesheet" type="text/css"
		...
		<div class="row">
			<div class="col-md-12 col-lg-12">
				<div class="bg-white p-5 rounded">
					...
					<div class="row">
						<div class="col-md-3 col-lg-12 col-xs-12 c5d5d5d">Merchant
							Registration</div>
						<div class="col-md-9 col-lg-12 col-xs-12 ">
							<div class="row">
								...
								<div class="col-8">
									<input type="button" onclick="addMDROrder()"
										class="btn btn-primary" value="Add"> <span>|</span>

									<button class="btn btn-primary" onclick="getGrabIdReport()">Get
										Grab Pay Report</button>
								</div>
							</div>
						</div>
					</div>
							...
							<tbody class="c3f3f3f fw500">
								<c:forEach var="reg" items="${registrationOrders}">
									...
									<tr>
										<td>${reg.id}</td>
										<%-- <td>${reg.createdOn}</td> --%>
										<fmt:parseDate value="${reg.createdOn}"
