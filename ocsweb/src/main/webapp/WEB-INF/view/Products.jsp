			...
			<body>
								...
								<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
									...
									<li class="nav-item" role="presentation" id="tab-host-rate">
										<button class="nav-link" id="pills-Host-tab" data-bs-toggle="pill"
											data-bs-target="#pills-Host" type="button" role="tab"
											aria-controls="pills-Host" aria-selected="false">Host
											Rate</button>
									</li>
									<li class="nav-item" role="presentation" id="tab-wallet-rate">
										<button class="nav-link" id="pills-Wallet-tab" data-bs-toggle="pill"
											...
											aria-controls="pills-Wallet" aria-selected="false">Wallet Rate</button>
									</li>
									<li class="nav-item" role="presentation">
								...
								<div class="tab-content" id="pills-tabContent">
									<div class="tab-pane fade show active" id="pills-Products" role="tabpanel"
										...
										<div id="product_details_1" class="row-fluid g-5 collapse">
											<div class="col-md-12 col-lg-12">
												<form:form method="POST" action="productAdd" modelAttribute="product"
															...
															<div class="col-sm-3  form-floating mb-3">
																<div class="mb-3">
																	...
																	<form:select class="form-select"
																		name="includeWallet" path="includeWallet"
																		id="includeWallet">
															...
															<div class="col-sm-3  form-floating mb-3">
																<div class="mb-3">
																	<form:label path="productSettlement"
																		class="form-label">Product Settlement(in days)
																	</form:label>
																	<form:select class="form-select"
														...
														<div id=ezySplitWalletData>
															<div class="row g-3 walletData">
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.boostMDREcomm"
																			class="form-label">Boost MDR Ecomm
																		</form:label>
																		<form:input
																			path="standardEzySplitMDRRate.boostMDREcomm"
																			id="boostMDREcomm_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.boostMDRQR"
																			class="form-label">Boost MDR QR</form:label>
																		<form:input
																			path="standardEzySplitMDRRate.boostMDRQR"
																			id="boostMDRQR_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.grabMDREcomm"
																			class="form-label">Grab MDR Ecomm
																		</form:label>
																		<form:input
																			path="standardEzySplitMDRRate.grabMDREcomm"
																			id="grabMDREcomm_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.grabMDRQR"
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.tngMDREcomm"
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.tngMDRQR"
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.shopeepayMDRQR"
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.fPXMDR_RM"
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.fPXMDR_Percent"
																			class="form-label">FPX MDR (%)</form:label>
																		<form:input
																			path="standardEzySplitMDRRate.fPXMDR_Percent"
																			id="fPXMDR_Percent_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.grabSettlement"
																			class="form-label">Grab Settlement
																		</form:label>
																		<form:input
																			path="standardEzySplitMDRRate.grabSettlement"
																			id="grabSettlement_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.tngSettlement"
																			class="form-label">Tng Settlement
																		</form:label>
																		<form:input
																			path="standardEzySplitMDRRate.tngSettlement"
																			id="tngSettlement_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		...
																		<form:input
																			path="standardEzySplitMDRRate.shopeepaySettlement"
																			id="shopeepaySettlement_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardEzySplitMDRRate.fpxSettlement"
																			class="form-label">FPX Settlement
																		</form:label>
																		<form:input
																			path="standardEzySplitMDRRate.fpxSettlement"
																			id="fpxSettlement_Ezysplit"
																			class="form-control" placeholder="" />
																	</div>
																</div>
															</div>
															...
															<div class="row g-3 walletData">
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3" id="id-boost-Ecomm">
																		...
																		<form:input path="standardmdrRate.boostMDREcomm"
																			id="boostMDREcomm" class="form-control"
																			placeholder="" />
																	</div>
																	<div class="mb-3" id="id-boost-qr">
																		...
																		<form:input path="standardmdrRate.boostMDRQR"
																			id="boostMDRQR" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3" id="id-grab-Ecomm">
																		...
																		<form:input path="standardmdrRate.grabMDREcomm"
																			id="grabMDREcomm" class="form-control"
																			placeholder="" />
																	</div>
																	<div class="mb-3" id="id-grab-qr">
																		...
																		<form:input path="standardmdrRate.grabMDRQR"
																			id="grabMDRQR" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3" id="id-tng-Ecomm">
																		...
																		<form:input path="standardmdrRate.tngMDREcomm"
																			id="tngMDREcomm" class="form-control"
																			placeholder="" />
																	</div>
																	<div class="mb-3" id="id-tng-qr">
																		<form:label path="standardmdrRate.tngMDRQR"
																			class="form-label">Tng MDR QR</form:label>
																		<form:input path="standardmdrRate.tngMDRQR"
																			id="tngMDRQR" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	...
																	<div class="mb-3" id="id-shopeepay-qr">
																		...
																		<form:input path="standardmdrRate.shopeepayMDRQR"
																			id="shopeepayMDRQR" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3" id="id-fpx-mdr-rm">
																		...
																		<form:input path="standardmdrRate.fPXMDR_RM"
																			id="fPXMDR_RM" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3" id="id-fpx-mdr-percentage">
																		<form:label
																			path="standardmdrRate.fPXMDR_Percent"
																			class="form-label">FPX MDR (%)</form:label>
																		<form:input
																			path="standardmdrRate.fPXMDR_Percent"
																			id="fPXMDR_Percent" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardmdrRate.boostSettlement"
																			class="form-label">Boost Settlement
																		</form:label>
																		<form:input
																			path="standardmdrRate.boostSettlement"
																			id="boostSettlement" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardmdrRate.grabSettlement"
																			class="form-label">Grab Settlement
																		</form:label>
																		<form:input
																			path="standardmdrRate.grabSettlement"
																			id="grabSettlement" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardmdrRate.TngSettlement"
																			class="form-label">Tng Settlement
																		</form:label>
																		<form:input
																			path="standardmdrRate.TngSettlement"
																			id="tngSettlement" class="form-control"
																			placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label
																			path="standardmdrRate.shopeepaySettlement"
																			class="form-label">Shopeepay Settlement
																		</form:label>
																		<form:input
																			path="standardmdrRate.shopeepaySettlement"
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3" id="id-fpx-settlement">
																		...
																		<form:input path="standardmdrRate.fpxSettlement"
																			id="fpxSettlement" class="form-control"
																			placeholder="" />
																	</div>
																</div>
															</div>
														...
														<div id="nonEzysplitProductDiv">
															...
															<div id="HostMDRDiv" style="display: none;">
																<div class="row g-3">
																	<div
																		class="col-sm-3  form-floating mb-3 d-flex align-items-center justify-content-center">
																		<div class="mb-3 small ">Local Debit Host MDR
																			(%)
																		</div>
																	</div>
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Debit_Host_Visa"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Debit_Host_Master"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Debit_Host_Union"
																				readOnly="true"
																...
																<div class="row g-3">
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Credit_Host_Visa"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Credit_Host_Master"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Credit_Host_Union"
																				readOnly="true"
																...
																<div class="row g-3">
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Debit_Host_Visa"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Debit_Host_Master"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Debit_Host_Union"
																				readOnly="true"
																...
																<div class="row g-3">
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Credit_Host_Visa"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Credit_Host_Master"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Credit_Host_Union"
																				readOnly="true"
															...
															<div id="MobiMDRDiv" style="display: none;">
																...
																<div class="row g-3">
																	<div
																		class="col-sm-3  form-floating mb-3 d-flex align-items-center justify-content-center">
																		<div class="mb-3 small ">Local Debit Mobi MDR
																			(%)
																		</div>
																	</div>
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Debit_Mobi_Visa"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Debit_Mobi_Master"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Debit_Mobi_Union"
																				readOnly="true"
																...
																<div class="row g-3">
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Credit_Mobi_Visa"
																				readOnly="true"
																				path="standardmdrRate.loc_Debit_Mobi_Visa"
																				class="form-control"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Credit_Mobi_Master"
																				readOnly="true"
																				path="standardmdrRate.loc_Debit_Mobi_Master"
																				class="form-control"
																				placeholder="Local Credit Mobi MDR (%)" />
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="loc_Credit_Mobi_Union"
																				readOnly="true"
																				path="standardmdrRate.loc_Debit_Mobi_Union"
																				class="form-control"
																				placeholder="Local Credit Mobi MDR (%)" />
																...
																<div class="row g-3">
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Debit_Mobi_Visa"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Debit_Mobi_Master"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Debit_Mobi_Union"
																				readOnly="true"
																...
																<div class="row g-3">
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Credit_Mobi_Visa"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Credit_Mobi_Master"
																				readOnly="true"
																	...
																	<div class="col-sm-2  form-floating mb-3">
																		<div class="mb-3">
																			<form:input id="for_Credit_Mobi_Union"
																				readOnly="true"
																...
																<div class="col-6">
																	...
																	<div class="row g-3">
																		<div
																			...
																			<div class="mb-3 small ">Merchant MDR (%)
																			</div>
																		</div>
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Merch_Master_Insta3"
																	...
																	<div class="row g-3">
																		<div
																			class="col-sm-6  form-floating mb-3 d-flex align-items-center justify-content-center">
																			<div class="mb-3 small ">Customer MDR (%)
																			</div>
																		</div>
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Cus_Master_Insta3"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Host_Master_Insta3"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Mobi_Master_Insta3"
																...
																<div class="col-6">
																	...
																	<div class="row g-3">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Merch_Master_Insta6"
																	...
																	<div class="row g-3">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Cus_Master_Insta6"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Host_Master_Insta6"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Mobi_Master_Insta6"
																...
																<div class="col-6">
																	...
																	<div class="row g-3">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Merch_Master_Insta9"
																	...
																	<div class="row g-3">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Cus_Master_Insta9"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Host_Master_Insta9"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Mobi_Master_Insta9"
																...
																<div class="col-6">
																	...
																	<div class="row g-3">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Merch_Master_Insta12"
																	...
																	<div class="row g-3">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Cus_Master_Insta12"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Host_Master_Insta12"
																	...
																	<div class="row g-3" style="display: none;">
																		...
																		<div class="col-sm-4  form-floating mb-3">
																			<div class="mb-3">
																				<form:input
																					id="loc_Credit_Mobi_Master_Insta12"
									...
									<div class="tab-pane fade" id="pills-Host" role="tabpanel"
										...
										<hr />
										<form:form method="POST" action="hostAdd" modelAttribute="hostRate"
											accept-charset="utf-8">
														...
														<div id="ezysplitHostRateDiv">
															...
															<div class="row g-3">
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:input
																			path="loc_Credit_Host_Master_EZYSPLIT"
																			class="form-control" type="number" min="0"
																			max="4" step="0.001"
									...
									<div class="tab-pane fade" id="pills-Wallet" role="tabpanel"
										...
										<hr />
										<form:form method="POST" action="walletRateAdd" modelAttribute="walletRate"
											accept-charset="utf-8">
													...
													<div class="bg-white  rounded form">
														...
														<div>
															...
															<div class="row g-3 walletData">
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label path="boostMDREcomm"
																			class="form-label">Boost MDR Ecomm
																		</form:label>
																		<form:input path="boostMDREcomm"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label path="boostMDRQR"
																			class="form-label">Boost MDR QR</form:label>
																		<form:input path="boostMDRQR"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label path="grabMDREcomm"
																			class="form-label">Grab MDR Ecomm
																		</form:label>
																		<form:input path="grabMDREcomm"
																			class="form-control" placeholder="" />
																	</div>
																</div>
             ...
             <div class="col-sm-3  form-floating mb-3">
              ...
              <!-- 			rk added -->
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label path="fPXMDR_Percent"
																			class="form-label">FPX MDR (%)</form:label>
																		<form:input path="fPXMDR_Percent"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label path="boostSettlement"
																			class="form-label">Boost Settlement
																		</form:label>
																		<form:input path="boostSettlement"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label path="grabSettlement"
																			class="form-label">Grab Settlement
																		</form:label>
																		<form:input path="grabSettlement"
																			class="form-control" placeholder="" />
																	</div>
																</div>
																...
																<div class="col-sm-3  form-floating mb-3">
																	<div class="mb-3">
																		<form:label path="fpxSettlement"
																			class="form-label">FPX Settlement
																		</form:label>
																		<form:input path="fpxSettlement"
																			class="form-control" placeholder="" />
																	</div>
																</div>
															</div>
